...
//
//    private List<PatientHistoryBean> patientHistoryList;
//
//    @BeforeEach
//    public void setUp() {
//        MockitoAnnotations.openMocks(this);
//        patientHistoryList = new ArrayList<>();
//        patientHistoryList.add(new PatientHistoryBean(new ObjectId(), 1L, "lastname", "Notes 1"));
//        patientHistoryList.add(new PatientHistoryBean(new ObjectId(), 2L, "emantsal", "Notes 2"));
//    }
//
////    @Test
...
//        // Arrange
//        PatientHistoryBean patientHistory = new PatientHistoryBean(new ObjectId(), 15L, "autrenom", "autres notes");
//        when(microserviceNotesProxy.addPatientHistory(patientHistory)).thenReturn(patientHistory);
//
//        // Act
//        PatientHistoryBean result = patientHistoryController.addPatientHistory(patientHistory);
//
//        // Assert
//        assertNotNull(result);
...
//        PatientHistoryBean patientToUpdate = new PatientHistoryBean(new ObjectId(), 15L, "autrenom", "autres notes");
//        PatientHistoryBean updatedPatientHistory = new PatientHistoryBean(new ObjectId(), 1L, "John", "Updated Assessment");
//        when(microserviceNotesProxy.updatePatientByLastname(lastname, patientToUpdate)).thenReturn(updatedPatientHistory);
//
//        // Act
//        PatientHistoryBean result = patientHistoryController.updatePatientByLastname(lastname, patientToUpdate);
//
//        // Assert
//        assertNotNull(result);
...
//        // Arrange
//        Long patId = 1L;
//        PatientHistoryBean patientToUpdate = new PatientHistoryBean(new ObjectId(), 1L, "autrenom", "autres notes");
//        PatientHistoryBean updatedPatientHistory = new PatientHistoryBean(new ObjectId(), 15L, "autrenom", "Notes updates");
//        when(microserviceNotesProxy.updatePatientById(patId, patientToUpdate)).thenReturn(updatedPatientHistory);
//
//        // Act
//        PatientHistoryBean result = patientHistoryController.updatePatientById(patId, patientToUpdate);
//
//        // Assert
//        assertNotNull(result);
//        assertEquals(updatedPatientHistory, result);
...
//        PatientHistoryBean deletedPatientHistory = new PatientHistoryBean(new ObjectId(), 15L, "autrenom", "autres notes");
//        when(microserviceNotesProxy.deletePatientByLastname(lastname)).thenReturn(deletedPatientHistory);
//
//        // Act
//        PatientHistoryBean result = patientHistoryController.deletePatientByLastname(lastname);
//
//        // Assert
//        assertNotNull(result);
...
//        // Arrange
//        Long patId = 1L;
//        PatientHistoryBean deletedPatientHistory = new PatientHistoryBean(new ObjectId(), 1L, "autrenom", "autres notes");
//        when(microserviceNotesProxy.deletePatientById(patId)).thenReturn(deletedPatientHistory);
//
//        // Act
//        PatientHistoryBean result = patientHistoryController.deletePatientById(patId);
//
//        // Assert
//        assertNotNull(result);
//        assertEquals(deletedPatientHistory, result);
